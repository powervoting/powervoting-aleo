...
/***/ "./src/content/multiChainWallet.ts":
/*!*****************************************!*\
  !*** ./src/content/multiChainWallet.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AleoWallet: () => (/* binding */ AleoWallet),
/* harmony export */   AleoWalletAccount: () => (/* binding */ AleoWalletAccount)
/* harmony export */ });
...
var _AleoWalletAccount_publicKey, _AleoWallet_instances, _AleoWallet_name, _AleoWallet_icon, _AleoWallet_accounts, _AleoWallet_connected, _AleoWallet_listeners, _AleoWallet_rpc, _AleoWallet_connect, _AleoWallet_decrypt, _AleoWallet_transfer, _AleoWallet_sign, _AleoWallet_records, _AleoWallet_execute, _AleoWallet_cancelPre, _AleoWallet_disConnect, _AleoWallet_on, _AleoWallet_emit, _AleoWallet_off;
class AleoWalletAccount {
    get address() {
        return '0x111111111';
    }
    get publicKey() {
        return __classPrivateFieldGet(this, _AleoWalletAccount_publicKey, "f").slice();
    }
    get chains() {
        return [];
    }
    get features() {
        return ['experimental:signTransaction'];
    }
    constructor(publicKey) {
        _AleoWalletAccount_publicKey.set(this, void 0);
        if (new.target === AleoWalletAccount) {
            Object.freeze(this);
        }
        __classPrivateFieldSet(this, _AleoWalletAccount_publicKey, publicKey, "f");
    }
}
_AleoWalletAccount_publicKey = new WeakMap();
class AleoWallet {
    get version() {
        return '1.0.0';
    }
    get name() {
        return __classPrivateFieldGet(this, _AleoWallet_name, "f");
    }
    get icon() {
        return __classPrivateFieldGet(this, _AleoWallet_icon, "f");
    }
    get chains() {
        return [];
    }
    get features() {
        return {
            'standard:connect': {
                version: '1.0.0',
                connect: __classPrivateFieldGet(this, _AleoWallet_connect, "f"),
            },
            'standard:events': {
                version: '1.0.0',
                on: __classPrivateFieldGet(this, _AleoWallet_on, "f"),
            },
            'standard:decrypt': {
                version: '1.0.0',
                decrypt: __classPrivateFieldGet(this, _AleoWallet_decrypt, "f"),
            },
            'standard:transfer': {
                version: '1.0.0',
                transfer: __classPrivateFieldGet(this, _AleoWallet_transfer, "f"),
            },
            'standard:sign': {
                version: '1.0.0',
                sign: __classPrivateFieldGet(this, _AleoWallet_sign, "f"),
            },
            'standard:records': {
                version: '1.0.0',
                records: __classPrivateFieldGet(this, _AleoWallet_records, "f"),
            },
            'standard:execute': {
                version: '1.0.0',
                execute: __classPrivateFieldGet(this, _AleoWallet_execute, "f"),
            },
            "standard:cancelPre": {
                version: '1.0.0',
                cancelPre: __classPrivateFieldGet(this, _AleoWallet_cancelPre, "f"),
            },
            "standard:disConnect": {
                version: "1.0.0",
                disConnect: __classPrivateFieldGet(this, _AleoWallet_disConnect, "f")
            }
        };
    }
    get accounts() {
        return __classPrivateFieldGet(this, _AleoWallet_accounts, "f");
    }
    get connected() {
        return __classPrivateFieldGet(this, _AleoWallet_connected, "f");
    }
    constructor(rpc) {
        _AleoWallet_instances.add(this);
        _AleoWallet_name.set(this, 'MultiChain Wallet');
        // TODO: Add image.
        _AleoWallet_icon.set(this, 'data:image/svg+xml;base64,');
        _AleoWallet_accounts.set(this, []);
        _AleoWallet_connected.set(this, false);
        _AleoWallet_listeners.set(this, {});
        _AleoWallet_rpc.set(this, void 0);
        _AleoWallet_connect.set(this, () => __awaiter(this, void 0, void 0, function* () {
            // console.log("[content-multiChainWallet] #connect");
            const accounts = yield __classPrivateFieldGet(this, _AleoWallet_rpc, "f").callMethod('connect');
            // console.log("[content-multiChainWallet] #connect accounts:", accounts);
            if (accounts === null) {
                throw new Error('The user rejected the request.');
            }
            __classPrivateFieldSet(this, _AleoWallet_accounts, accounts, "f");
            __classPrivateFieldSet(this, _AleoWallet_connected, true, "f");
            // this.#emit('change', { accounts: this.accounts });
            return __classPrivateFieldGet(this, _AleoWallet_accounts, "f");
        }));
        _AleoWallet_decrypt.set(this, (params) => __awaiter(this, void 0, void 0, function* () {
            // console.log("[content-multiChainWallet] #decrypt params:", params);
            const record = yield __classPrivateFieldGet(this, _AleoWallet_rpc, "f").callMethod('decrypt', params);
            // if (record) {
            //   throw new Error('[content-multiChainWallet] #decrypt The user rejected the request.');
            // }
            // console.log("[content-multiChainWallet] #decrypt record:", record);
            return record;
        }));
        _AleoWallet_transfer.set(this, (params) => __awaiter(this, void 0, void 0, function* () {
            // console.log("[content-multiChainWallet] #transfer params:", params);
            const transferResult = yield __classPrivateFieldGet(this, _AleoWallet_rpc, "f").callMethod('transfer', params);
            // console.log("[content-multiChainWallet] #transfer Result:", transferResult);
            return transferResult;
        }));
        _AleoWallet_sign.set(this, (params) => __awaiter(this, void 0, void 0, function* () {
            // console.log("[content-multiChainWallet] #sign params:", params);
            const signResult = yield __classPrivateFieldGet(this, _AleoWallet_rpc, "f").callMethod('sign', params);
            // console.log("[content-multiChainWallet] #sign Result:", signResult);
            return signResult;
        }));
        _AleoWallet_records.set(this, (params) => __awaiter(this, void 0, void 0, function* () {
            const signResult = yield __classPrivateFieldGet(this, _AleoWallet_rpc, "f").callMethod('records', params);
            return signResult;
        }));
        _AleoWallet_execute.set(this, (params) => __awaiter(this, void 0, void 0, function* () {
            // console.log("[content-multiChainWallet] #execute params:", params);
            const executeResult = yield __classPrivateFieldGet(this, _AleoWallet_rpc, "f").callMethod('execute', params);
            // console.log("[content-multiChainWallet] #execute Result:", executeResult);
            return executeResult;
        }));
        _AleoWallet_cancelPre.set(this, () => __awaiter(this, void 0, void 0, function* () {
            const result = yield __classPrivateFieldGet(this, _AleoWallet_rpc, "f").callMethod('cancelPre');
            return result;
        }));
        _AleoWallet_disConnect.set(this, () => __awaiter(this, void 0, void 0, function* () {
            __classPrivateFieldSet(this, _AleoWallet_accounts, [], "f");
            __classPrivateFieldSet(this, _AleoWallet_connected, false, "f");
        }));
        _AleoWallet_on.set(this, (event, listener) => {
            var _a;
            ((_a = __classPrivateFieldGet(this, _AleoWallet_listeners, "f")[event]) === null || _a === void 0 ? void 0 : _a.push(listener)) || (__classPrivateFieldGet(this, _AleoWallet_listeners, "f")[event] = [listener]);
            return () => __classPrivateFieldGet(this, _AleoWallet_instances, "m", _AleoWallet_off).call(this, event, listener);
        });
        if (new.target === AleoWallet) {
            Object.freeze(this);
        }
        __classPrivateFieldSet(this, _AleoWallet_rpc, rpc, "f");
    }
}
_AleoWallet_name = new WeakMap(), _AleoWallet_icon = new WeakMap(), _AleoWallet_accounts = new WeakMap(), _AleoWallet_connected = new WeakMap(), _AleoWallet_listeners = new WeakMap(), _AleoWallet_rpc = new WeakMap(), _AleoWallet_connect = new WeakMap(), _AleoWallet_decrypt = new WeakMap(), _AleoWallet_transfer = new WeakMap(), _AleoWallet_sign = new WeakMap(), _AleoWallet_records = new WeakMap(), _AleoWallet_execute = new WeakMap(), _AleoWallet_cancelPre = new WeakMap(), _AleoWallet_disConnect = new WeakMap(), _AleoWallet_on = new WeakMap(), _AleoWallet_instances = new WeakSet(), _AleoWallet_emit = function _AleoWallet_emit(event, ...args) {
    var _a;
    // eslint-disable-next-line prefer-spread
    (_a = __classPrivateFieldGet(this, _AleoWallet_listeners, "f")[event]) === null || _a === void 0 ? void 0 : _a.forEach((listener) => listener.apply(null, args));
}, _AleoWallet_off = function _AleoWallet_off(event, listener) {
    var _a;
    __classPrivateFieldGet(this, _AleoWallet_listeners, "f")[event] = (_a = __classPrivateFieldGet(this, _AleoWallet_listeners, "f")[event]) === null || _a === void 0 ? void 0 : _a.filter((existingListener) => listener !== existingListener);
};
...
/* harmony import */ var _multiChainWallet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./multiChainWallet */ "./src/content/multiChainWallet.ts");



function register() {
    const transport = (0,_messages__WEBPACK_IMPORTED_MODULE_0__.createWindowTransport)(window);
    const rpc = (0,_messages__WEBPACK_IMPORTED_MODULE_0__.createRPC)(transport);
    // registerWallet(new AleoWallet(rpc));
    // @ts-ignore
    window.wallet = new _multiChainWallet__WEBPACK_IMPORTED_MODULE_1__.AleoWallet(rpc);
}
register();
